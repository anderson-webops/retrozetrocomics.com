...
const showSupportRails = computed(
	() => !isHomeRoute.value && !isPostDetailRoute.value
);
...
<template>
	<main class="site-shell">
		...
		<div
			class="content-grid"
			:class="{ 'content-grid--single': !showSupportRails }"
		>
			<SideAdvertisement
				v-if="showSupportRails"
				class="content-grid__ad"
				variant="archive"
			/>
