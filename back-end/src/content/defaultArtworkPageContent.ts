const defaultArtwork = {
	"items": [
		...
		},
		{
			...
			"collection": "zetro",
			"caption": "An original resketch of Zetro, who appears with Retro and in an adventure trio with Zatral and Zat.",
...
export function createDefaultArtworkPageContent() {
	return JSON.parse(JSON.stringify(defaultArtwork)) as typeof defaultArtwork;
}
